  ...
  return (
    <>
      <div className="container w-75">
        ...
        <h4 style={{color:"black", fontFamily:"times new roman"}}>Shipping Method</h4>
        <form>
          <div className="mb-3">
            <label htmlFor="shippingMethod" className="form-label" style={{color:"black",fontSize:"20px", fontFamily:"times new roman"}}>
