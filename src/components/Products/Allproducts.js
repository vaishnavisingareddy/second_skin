...
export default function Allproducts({ data }) {
  ...
  return (
    <>
      <div className="container-fluid mt-0 m-auto sortcolor">
        <div style={{ textAlign: 'center' , borderRadius:'0px', width:'100px' }}>
          {/* Sorting dropdown */}
          <select value={sortingOption} onChange={handleSortOptionChange} className='sortbutton'>
        ...
        <div className="card mt-4 allitems">
