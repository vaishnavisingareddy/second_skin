            ...
            <div className="container w-75">
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        <li className="breadcrumb-item" style={{fontFamily:"times new roman"}} ><Link to="/cart">Cart</Link></li>
                        <li className="breadcrumb-item active" aria-current="page" style={{fontFamily:"times new roman"}}><Link to="/checkout/info">Information</Link></li>
                        <li className="breadcrumb-item" style={{fontFamily:"times new roman"}}><Link to="/checkout/shipping">Shipping</Link></li>
                        <li className="breadcrumb-item" style={{fontFamily:"times new roman"}}><Link to="/checkout/payment">Payment</Link></li>
                    </ol>
                </nav>
                <form>
                    <h4 style={{fontFamily:"times new roman", fontSize:"30px", color:"black"}}>Contact</h4>
                    <input type="email" className="form-control mt-3 mb-1" placeholder="Email" onChange={emailchange} />
                
                    <h4 className="mt-4 mb-3" style={{fontFamily:"times new roman", fontSize:"25px", color:"black"}}>Shipping Address</h4>
