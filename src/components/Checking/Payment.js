    ...
    return (
        <>
            <div className="container w-75">
                ...
                <h4 style={{color:"black", fontFamily:"times new roman"}}>Payment</h4>
                <div style={{color:"black",fontSize:"20px", fontFamily:"times new roman"}}>
                ...
                <div className="border border-success d-flex justify-content-between p-3 rounded-4 my-3 px-5 bg-success bg-opacity-10">
                    <div className="payment-options" style={{color:"black",fontSize:"20px", fontFamily:"times new roman"}}>
